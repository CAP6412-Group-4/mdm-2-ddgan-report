...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.55\textwidth]{imgs/pidm/pidm_0.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.55\textwidth]{imgs/pidm/pidm_1.png}}
...
for PIDM. Next, is to take the target pose image sample and create a numpy array representation of it.

% TODO: Discuss how we converted our custom image to the appropriate numpy shape.
...
\begin{figure}[h]
    ...
    person who is facing their back towards us. The }
    \label{fig:pidm-2}
\end{figure}
